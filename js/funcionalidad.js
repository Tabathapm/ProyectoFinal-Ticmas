...
$.ajax({
    ...
    success: function(data) {
        ...
        apellidoPersona.innerText       = "Peralta";
        nombrePersona.innerText         = "Tabatha";
        identificacionPersona.innerText = "39873678";
        nacimientoPersona.innerText     = "03-10-1996 (26 años)";
        residenciaPersona.innerText     = "Rafael Castillo, Buenos Aires, Argentina";
        callePersona.innerText          = "Titanic 2026";
        codPostPersona.innerText        = "1755";
        zonaHorariaPersona.innerText    = "Buenos Aires (GMT-3)";
        correoElectPersona.innerText    = "tabathapm@gmail.com";
        telMovilPersona.innerText       = "1136696667";
        telFijoPersona.innerText        = "   - - -";
